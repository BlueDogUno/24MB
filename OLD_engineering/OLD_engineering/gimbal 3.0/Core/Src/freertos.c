...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of forearm */
  osThreadDef(forearm, forearm_task, osPriorityNormal, 0, 128);
  forearmHandle = osThreadCreate(osThread(forearm), NULL);

 osThreadDef(communication, communication_task, osPriorityNormal, 0, 128);
