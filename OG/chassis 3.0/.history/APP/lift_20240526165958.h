...
typedef struct
{
    ...
    #define dial_stop                   (strt.rc_data->rc.ch[4] == 0)
...
void lift_init(void);
void pump_contorl_send(void);   //气泵控制   
